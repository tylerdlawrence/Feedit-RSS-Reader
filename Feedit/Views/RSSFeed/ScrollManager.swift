...
//  Feedit
//
//  Created by Tyler D Lawrence on 12/22/20.
//
...
struct ScrollingManagerView: View {
        ...
        VStack {
            ...
            HStack {
                ...
                .overlay(
                    ...
                    ScrollManagerView(scrollManager: scrollManager, indexPathToSetVisible: $indexPathToSetVisible)
                        .frame(width: 0, height: 0)
                )
            }
        }
...
struct ScrollingManager_Previews: PreviewProvider {
    static var previews: some View {
        ScrollingManagerView()
    }
}
